...
\begin{equation}
  (O.x + t\times \vec{D}.x)^2 + \\
  (O.y + t\times \vec{D}.y)^2 = \\
  (O.z + t\times \vec{D}.z)^2
\end{equation}
This equation expands to:
\begin{equation}
\begin{split}
  (\vec{D}.x^2 + \vec{D}.y^2 - \vec{D}.z^2)\times t^2 + \\
  (2O.x\times \vec{D}.x + 2O.y\times \vec{D}.y - 
  2O.z\times \vec{D}.z)\times t \\
...
\begin{split}
  ...
  B = 2O.x\times \vec{D}.x + 2O.y\times \vec{D}.y \\
  C = O.x^2 + O.y^2 - 1
\end{split}
\end{equation}
